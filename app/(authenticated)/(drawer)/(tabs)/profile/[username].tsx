...
export default function ProfileScreen() {
  ...
  let {username} = useGlobalSearchParams();
  ...
  const {data} = useQuery({
    ...
    queryFn: async () => {
      return fetch(`${API_SERVER_URL}/user/${username}`, options).then(toJson);
    },
  });
  ...
  const {data: posts} = useQuery({
    ...
    queryFn: async () => {
      return fetch(`${API_SERVER_URL}/user/${username}/posts`, options).then(
        toJson,
      );
    },
  });
  ...
  const {data: followers} = useQuery({
    ...
    queryFn: async () => {
      return fetch(
        `${API_SERVER_URL}/user/${username}/followers`,
        options,
      ).then(toJson);
    },
  });
  ...
  const {data: following} = useQuery({
    ...
    queryFn: async () => {
      return fetch(
        `${API_SERVER_URL}/user/${username}/following`,
        options,
      ).then(toJson);
    },
  });
